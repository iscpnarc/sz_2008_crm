	...
	<script>
        ...
        jQuery(function ($) {
            $("#loginBtn").click(function() {
                ...
                //$('#autoLogin').is(':checked'); //返回 true/false
                /*if($('#autoLogin').is(':checked')){
                    data.autoLogin = $("#autoLogin").val();
                }*/
        ...
        <form class="form-horizontal" role="form">
            <div class="form-group form-group-lg">
                <div style="width: 350px;">
                    <input id="username" class="form-control" value="1000" type="text" placeholder="用户名">
                </div>
                <div style="width: 350px; position: relative;top: 20px;">
                    <input id="password" class="form-control" value="a" type="password" placeholder="密码">
                </div>
                <div class="checkbox" style="position: relative;top: 30px; left: 10px;">
                    <label>
                        <input id="autoLogin" type="checkbox" value="0"> 十天内免登录
                    </label>
                </div>
